...
- Advanced Vector Calculus and Real Analysis / [link](https://ocw.mit.edu/courses/18-02sc-multivariable-calculus-fall-2010/) | [notes](https://ocw.mit.edu/courses/18-100a-real-analysis-fall-2020/download/) | [book](https://www.matrixeditions.com/UnifiedApproach.html)
...
- Proofs, calculus, and linear algebra for theorists / [notes](https://courses.csail.mit.edu/6.042/spring18/mcs.pdf)
- Probability, statistics, and stochastic intuition / [notes](https://probabilitybook.net/)
- Mathematical methods for physicists / [notes](https://www.damtp.cam.ac.uk/user/tong/matmethods.html)
- Classical mechanics, fields, and variational thinking / [notes](https://www.damtp.cam.ac.uk/user/tong/dynamics.html)
- Quantum mechanics and operator methods / [notes](https://ocw.mit.edu/courses/8-05-quantum-physics-ii-fall-2013/download/)
- Statistical physics and many-body reasoning / [notes](https://www.damtp.cam.ac.uk/user/tong/statphys.html)
- Geometry, topology, and spacetime structure / [notes](https://www.preposterousuniverse.com/wp-content/uploads/grnotes-one.pdf)
- Computation, numerical methods, and scientific Python / [notes](https://lectures.scientific-python.org/)
