...
![Layout of the booth. The projector screen displays our interactive reinforcement learning demo, with keyboard and mouse near the projector for interactivity, and the group poster is positioned to the right of the projector screen. The "ask me anything" station is to the right of the projector and the circuit generation game is to the right of that.](/assets/images/Outreach/Booth_Outline.jpeg)
...
![The main screen of the interactive reinforcement learning demo.](/assets/images/Outreach/RL_Demo_Main_Screen.png?raw=true)

![The "level complete" pop-up message when you finish a level.](/assets/images/Outreach/RL_Demo_Level_Complete.png?raw=true)

![The main screen of the interactive reinforcement learning demo in German.](/assets/images/Outreach/RL_Demo_Main_Screen_German.png?raw=true)
...
![Instructions for the level.](/assets/images/Outreach/RL_Demo_Level_Info.png?raw=true)
...
![General information about reinforcement learning.](/assets/images/Outreach/RL_Demo_General_Info.png?raw=true)
...
![Further information about projective simulation.](/assets/images/Outreach/RL_Demo_PS_Info.png?raw=true)
...
![Learning tips and hints when you get stuck on a level.](/assets/images/Outreach/RL_Demo_Learning_Tips.png?raw=true)
...
![](/assets/images/Outreach/Circuit_Gen_Station.jpeg)
...
![](/assets/images/Outreach/Group_Poster.jpeg)
